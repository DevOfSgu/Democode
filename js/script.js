...
function showTrailer(){
   videoTrailer.classList.add('open');
}
function closeTrailer(){
    videoTrailer.classList.remove('open');
    
}
buttonTrailer.addEventListener('click',showTrailer)
videoTrailer.addEventListener('click',closeTrailer)
modalTrailer.addEventListener('click', function(event){
